...
function gera() {
  ...
  try {
    senha = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__.default)(qtdCaracteres.value, chkMaiusculas.checked, chkMinusculas.checked, chkNumeros.checked, chkSimbolos.checked);
  } catch (e) {
    senha = "Nada selecionado";
  }
...
function geraSenha(qtd, maiusculas, minusculas, numeros, simbolos) {
  ...
  return senhaArray.reduce(function (x, y) {
    return x + y;
  }).slice(0, qtd);
}
...
/* harmony import */ var _src_assets_css_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/assets/css/style.css */ "./src/assets/css/style.css");
